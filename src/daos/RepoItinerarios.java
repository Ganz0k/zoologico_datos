...
public class RepoItinerarios {
    ...
    /**
     * Método privado que regresa la colección "itinerarios" y la sujeta al formato
     * de la clase Itinerario.
     * 
    ...
    /**
     * Método que hace una consulta a la colección itinerarios de la base de datos, 
     * la consulta que realiza es buscar si hay un itinerario guardado en ella que
     * coincida con el nombre dado como parámetro, regresa un itinerario en el caso
     * de que encuentre uno, null en caso contrario.
     * 
